class_name GameItemBase extends NakamaItemBase
...
var collection_to_enum_map: Dictionary = {
	"items_plant_area": EItemTypes.PLANTABLE_AREA,
	"items_walkable_area": EItemTypes.WALKABLE_AREA
}
